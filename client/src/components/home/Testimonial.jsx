...
const Testimonial = () => {
  ...
  },
  {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">I built a clean, ATS-friendly resume in minutes and landed more interview opportunities.</p>
        </div>
    );
  ...
  description="See how job seekers are creating professional resumes and landing interviews with our platform."
/> </div>
